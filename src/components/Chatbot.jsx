        ...
        <div className="chat enter">
          {isChatTab ? (
            <div className="header">
              ...
              <span className="title" >MacCall Hotel</span>
              ...
              <ul className="messages-two">
                ...
                <li>
                  <div className="first-list">
                    ...
                    <span>
                      <p>MacCall Hotel Management & Development</p>
                      <p>Hello there!</p>
                    </span>
                  </div>
                ...
                <a href="https://maccall.com/portfolio/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎓 Services
                    <Services />
                  </li>
                </a>
                <a href="https://maccall.com/" target="_blank" rel="noopener noreferrer">
                  <li>
                    🎉 Resources
                    <Resources />
                  </li>
                </a>
                <a href="https://maccall.com/contact/" target="_blank" rel="noopener noreferrer">
                  <li>
                    💬 Contact us
                    <Contact />
                  </li>
