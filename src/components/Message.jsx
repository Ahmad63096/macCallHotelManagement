...
function Message() {
  ...
  const handleButtonClick = (buttonText) => {
    ...
    const buttonResponses = {
      "Hotel Management": "I want to know about Hotel Management.",
      "Sales & Marketing": "I want to know about Sales & Marketing.",
      "Revenue Optimization": "I want to know about Revenue Optimization.",
      "Site Development": "I want to know about Site Development."
    };
  ...
  useEffect(() => {
    const fetchGreetingMessage = async () => {
      try {
        const data = "Hey there! I’m your virtual assistant at MacCall Hotel Management & Development. How are you today?😊";
